...
<div id="bb-container" class="bb-container">
    ...
    <input type="hidden" id="deleteBlockTypeFolderUrl" value="<?php echo URL::to('ajax/delete-block-type-folder'); ?>" />
    ...
    <form method="post" action="<?php echo $formAction; ?>">
        ...
        <ul class="navigation-tabs" id="navigation-tabs">
            ...
            <li><a href="#" data-tab="tab-basic"      class="btn btn-default <?php in_array('tab-basic', $tabsWithError) ? print 'has-error' : false; ?>"><?php echo t('Tab: Basic information'); ?></a></li>
            <li><a href="#" data-tab="tab-entries"    class="btn btn-default <?php in_array('tab-entries', $tabsWithError) ? print 'has-error' : false; ?>"><?php echo t('Tab: Repeatable entries'); ?></a></li>
        </ul>
        ...
        <div class="ccm-tab-content" id="ccm-tab-content-block-settings">
            ...
            <div class="row">
                <div class="col-md-6 form-group <?php in_array('blockName', $fieldsWithError) ? print 'has-error' : false; ?>">
                    ...
                    <?php echo $form->text('blockName', $blockName, array('maxlength' => '100')); ?>
                </div>
                <div class="col-md-6 form-group <?php in_array('blockHandle', $fieldsWithError) ? print 'has-error' : false; ?>">
                    ...
                    <?php echo $form->text('blockHandle', $blockHandle, array('maxlength' => '50')); ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 form-group <?php in_array('blockDescription', $fieldsWithError) ? print 'has-error' : false; ?>">
                    ...
                    <?php echo $form->textarea('blockDescription', $blockDescription, array('maxlength' => '100')); ?>
                </div>
        ...
        <div class="ccm-tab-content" id="ccm-tab-content-texts">
            ...
            <div class="form-group <?php in_array('basicLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('basicLabel', $basicLabel, array('data-translated-text'=>t('Basic information'), 'data-untranslated-text'=>'Basic information')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('entriesLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('entriesLabel', $entriesLabel, array('data-translated-text'=>t('Entries'), 'data-untranslated-text'=>'Entries')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('addAtTheTopLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('addAtTheTopLabel', $addAtTheTopLabel, array('data-translated-text'=>t('Add at the top'), 'data-untranslated-text'=>'Add at the top')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('addAtTheBottomLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('addAtTheBottomLabel', $addAtTheBottomLabel, array('data-translated-text'=>t('Add at the bottom'), 'data-untranslated-text'=>'Add at the bottom')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('copyLastEntryLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('copyLastEntryLabel', $copyLastEntryLabel, array('data-translated-text'=>t('Copy last entry'), 'data-untranslated-text'=>'Copy last entry')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('collapseAllLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('collapseAllLabel', $collapseAllLabel, array('data-translated-text'=>t('Collapse all'), 'data-untranslated-text'=>'Collapse all')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('expandAllLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('expandAllLabel', $expandAllLabel, array('data-translated-text'=>t('Expand all'), 'data-untranslated-text'=>'Expand all')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('noEntriesFoundLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('noEntriesFoundLabel', $noEntriesFoundLabel, array('data-translated-text'=>t('No entries found.'), 'data-untranslated-text'=>'No entries found.')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('maxNumberOfEntriesLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('maxNumberOfEntriesLabel', $maxNumberOfEntriesLabel, array('data-translated-text'=>t('Max. number of entries'), 'data-untranslated-text'=>'Max. number of entries')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('removeEntryLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('removeEntryLabel', $removeEntryLabel, array('data-translated-text'=>t('Remove entry'), 'data-untranslated-text'=>'Remove entry')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('duplicateEntryLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('duplicateEntryLabel', $duplicateEntryLabel, array('data-translated-text'=>t('Duplicate entry'), 'data-untranslated-text'=>'Duplicate entry')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('areYouSureLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('areYouSureLabel', $areYouSureLabel, array('data-translated-text'=>t('Are you sure?'), 'data-untranslated-text'=>'Are you sure?')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('requiredFieldsLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('requiredFieldsLabel', $requiredFieldsLabel, array('data-translated-text'=>t('Required fields'), 'data-untranslated-text'=>'Required fields')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('urlEndingLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('urlEndingLabel', $urlEndingLabel, array('data-translated-text'=>t('Custom string at the end of URL'), 'data-untranslated-text'=>'Custom string at the end of URL')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('urlEndingHelpText', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('urlEndingHelpText', $urlEndingHelpText, array('data-translated-text'=>t('(e.g. #contact-form or ?ccm_paging_p=2)'), 'data-untranslated-text'=>'(e.g. #contact-form or ?ccm_paging_p=2)')); ?>
            </div>

            <div class="form-group <?php in_array('textLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                <?php echo $form->label('textLabel', t('Text')); ?>
                <?php echo $form->text('textLabel', $textLabel, array('data-translated-text'=>t('Text'), 'data-untranslated-text'=>'Text')); ?>
            </div>

            <div class="form-group <?php in_array('titleLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                <?php echo $form->label('titleLabel', t('Title')); ?>
                <?php echo $form->text('titleLabel', $titleLabel, array('data-translated-text'=>t('Title'), 'data-untranslated-text'=>'Title')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('altTextLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('altTextLabel', $altTextLabel, array('data-translated-text'=>t('Alt text'), 'data-untranslated-text'=>'Alt text')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('linkFromSitemapLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('linkFromSitemapLabel', $linkFromSitemapLabel, array('data-translated-text'=>t('Link from Sitemap'), 'data-untranslated-text'=>'Link from Sitemap')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('linkFromFileManagerLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('linkFromFileManagerLabel', $linkFromFileManagerLabel, array('data-translated-text'=>t('Link from File Manager'), 'data-untranslated-text'=>'Link from File Manager')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('externalLinkLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('externalLinkLabel', $externalLinkLabel, array('data-translated-text'=>t('External Link'), 'data-untranslated-text'=>'External Link')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('showAdditionalFieldsLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('showAdditionalFieldsLabel', $showAdditionalFieldsLabel, array('data-translated-text'=>t('Show additional fields'), 'data-untranslated-text'=>'Show additional fields')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('hideAdditionalFieldsLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('hideAdditionalFieldsLabel', $hideAdditionalFieldsLabel, array('data-translated-text'=>t('Hide additional fields'), 'data-untranslated-text'=>'Hide additional fields')); ?>
            </div>
            ...
            <div class="form-group <?php in_array('newWindowLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                ...
                <?php echo $form->text('newWindowLabel', $newWindowLabel, array('data-translated-text'=>t('Open in new window'), 'data-untranslated-text'=>'Open in new window')); ?>
            </div>

            <div class="form-group <?php in_array('yesLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                <?php echo $form->label('yesLabel', t('Yes')); ?>
                <?php echo $form->text('yesLabel', $yesLabel, array('data-translated-text'=>t('Yes'), 'data-untranslated-text'=>'Yes')); ?>
            </div>

            <div class="form-group <?php in_array('noLabel', $fieldsWithError) ? print 'has-error' : false; ?>">
                <?php echo $form->label('noLabel', t('No')); ?>
                <?php echo $form->text('noLabel', $noLabel, array('data-translated-text'=>t('No'), 'data-untranslated-text'=>'No')); ?>
            </div>

        </div>

        <div class="ccm-tab-content" id="ccm-tab-content-tab-basic">
        ...
        <div class="ccm-tab-content" id="ccm-tab-content-tab-entries">
            ...
            <div class="entry-content js-entry-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group <% if (error['handle']!=undefined) { %>has-error<% } %>">
                        ...
                        <p class="small text-muted"><?php echo t('a-zA-Z characters only e.g. "productName"'); ?></p>
                        <input type="text"
                        ...
                        <% if (fieldType == 'textarea') { %>
                            <div class="<% if (error['textareaHeight']!=undefined) { %>has-error<% } %>">
                                ...
                                <p class="small text-muted">
                                    <?php echo t('Default height in c5.7: 54px. Default height in c5.8: 62px.'); ?>
                                </p>

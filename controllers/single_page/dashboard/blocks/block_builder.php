...
use Concrete\Package\BlockBuilder\Src\BlockBuilder\Generator as BlockBuilderGenerator;
use Concrete\Package\BlockBuilder\Src\BlockBuilder\Validation as BlockBuilderValidation;
use Concrete\Package\BlockBuilder\Src\BlockBuilder\OptionList as BlockBuilderOptionList;
...
class BlockBuilder extends DashboardPageController
{
    ...
    public function view() {
        ...
        $al->register('css', 'bb/styles', 'css_files/styles.css', array(), $pkg);
        $al->register('javascript', 'bb/scripts', 'js_files/block-builder.js', array(), $pkg);
    ...
    public function block_created() {
        ...
        $this->set('success', t('Block "%s" has been successfully created. Go to "Block Types" page to manually install it.', $_GET['blockNameCreated']));
    ...
    public function block_created_and_installed() {
        ...
        $this->set('success', t('Block "%s" has been successfully created and installed.', $_GET['blockNameCreated']));
